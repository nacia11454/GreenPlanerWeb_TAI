...
from greenCalendar.forms import BookingForm
from google.oauth2 import service_account


SCOPES = ["https://www.googleapis.com/auth/calendar"]

service_account_email = "nataliabartos01@gmail.com"
credentials = service_account.Credentials.from_service_account_file('green-354122-f572071af7c7.json')
scoped_credentials = credentials.with_scopes(SCOPES)
calendarId = "qr2lcrfd3huh01pscbc7ft7e2g@group.calendar.google.com"
...
class HomeView(FormView):
    ...
    template_name = 'greenCalendar/home.html'
    ...
    def form_valid(self, form):
        ...
        if start_date_data > end_date_data:
            ...
            return HttpResponseRedirect(reverse("greenCalendar:home"))
    ...
    def get_success_url(self):
        ...
        return reverse('greenCalendar:home')
